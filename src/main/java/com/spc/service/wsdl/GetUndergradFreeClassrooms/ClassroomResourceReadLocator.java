...
public class ClassroomResourceReadLocator extends org.apache.axis.client.Service implements com.spc.service.wsdl.GetUndergradFreeClassrooms.ClassroomResourceRead {
    ...
    public com.spc.service.wsdl.GetUndergradFreeClassrooms.ClassRoomReadService getClassroomResourceReadPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.spc.service.wsdl.GetUndergradFreeClassrooms.ClassRoomReadService getClassroomResourceReadPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.spc.service.wsdl.GetUndergradFreeClassrooms.ClassroomResourceReadPortSoapBindingStub _stub = new com.spc.service.wsdl.GetUndergradFreeClassrooms.ClassroomResourceReadPortSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.spc.service.wsdl.GetUndergradFreeClassrooms.ClassRoomReadService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.spc.service.wsdl.GetUndergradFreeClassrooms.ClassroomResourceReadPortSoapBindingStub _stub = new com.spc.service.wsdl.GetUndergradFreeClassrooms.ClassroomResourceReadPortSoapBindingStub(new java.net.URL(ClassroomResourceReadPort_address), this);
                _stub.setPortName(getClassroomResourceReadPortWSDDServiceName());
                return _stub;
            }
        }
