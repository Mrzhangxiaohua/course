...
public class PkCentrePkzyQueryLocator extends org.apache.axis.client.Service implements com.spc.service.wsdl.TeachersOccupyTimeWebservice.PkCentrePkzyQuery {
    ...
    public com.spc.service.wsdl.TeachersOccupyTimeWebservice.PkZyQueryService getPkCentrePkzyQueryPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.spc.service.wsdl.TeachersOccupyTimeWebservice.PkZyQueryService getPkCentrePkzyQueryPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.spc.service.wsdl.TeachersOccupyTimeWebservice.PkCentrePkzyQueryPortSoapBindingStub _stub = new com.spc.service.wsdl.TeachersOccupyTimeWebservice.PkCentrePkzyQueryPortSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.spc.service.wsdl.TeachersOccupyTimeWebservice.PkZyQueryService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.spc.service.wsdl.TeachersOccupyTimeWebservice.PkCentrePkzyQueryPortSoapBindingStub _stub = new com.spc.service.wsdl.TeachersOccupyTimeWebservice.PkCentrePkzyQueryPortSoapBindingStub(new java.net.URL(PkCentrePkzyQueryPort_address), this);
                _stub.setPortName(getPkCentrePkzyQueryPortWSDDServiceName());
                return _stub;
            }
        }
